...
export default function readBaseAlunos(){
  let readingData = []
  fs.createReadStream("./dataBase/Base de Alunos5.csv")
  ...
  .on("end", () => {
    ...
    const w = fs.createWriteStream('./results/dadosAlunos.csv');
    w.write(csvData)
    console.log('Dados dos alunos gravados no diretório:')
    console.log('\x1b[36m%s\x1b[0m',"./results/dadosAlunos.csv");
